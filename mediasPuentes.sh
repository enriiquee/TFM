...
#El script nos almacena los datos de los archivos en columnas. Lo que queremos es calcular la media en un instante determinado,
# por lo que dividimos entre el número de datos que posee 1 solo archivo
